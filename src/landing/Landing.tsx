...
const features = [
  ...
  { title: "Auto-Labeling & Online Learning", desc: "Labels outcomes and updates models as new data arrives.", Icon: BrainCircuit },
  { title: "Explainability & Drivers", desc: "Attribution by factors, regimes, and scenarios.", Icon: BarChart3 },
  { title: "Daily Quant Signal", desc: "Shortlist → rank → Monte Carlo → concise pick with blurb.", Icon: Sparkles },
];
